    ...
    <div class="container">
                    ...
                    <div class="movie-list">
                        <div class="movie-list-item">
                            ...
                            <p class="movie-list-item-desc">Jake Sully and Ney'tiri have formed a family and are doing everything to stay together. However, they must leave their home and explore the regions of Pandora. When an ancient threat resurfaces, Jake must fight a difficult war against the humans.</p>
                             ...
                             <button class="movie-list-item-button">Download</button>
                            <button class="movie-list-item-button1">Watch</button>  </form>
                          </div>

                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./holidate.webp" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./notebook.jpg" alt="">
                            <span class="movie-list-item-title">The Notebook</span>
                            <p class="movie-list-item-desc">In 1940s South Carolina, mill worker Noah Calhoun (Ryan Gosling) and rich girl Allie (Rachel McAdams) are desperately in love. But her parents don't approve...</p>
                            <form action="../Comingsoon/comingsoon.php">
                            <button class="movie-list-item-button">Download</button>
                            <button class="movie-list-item-button1">Watch</button>
                            </form>
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./black panther.jpeg" alt="">
            ...
            <div class="movie-list-container">
                ...
                <div class="movie-list-wrapper">
                    <div class="movie-list">
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./thor.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./doctorstrange.jpeg" alt="">
                            <span class="movie-list-item-title">Doctor Strange in the Multiverse of Madness</span>
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./avatarsequel.webp" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./Black_Adam_-_Infobox_Image.webp" alt="">
            ...
            <div class="featured-content"
                ...
                background-position: right top;background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('./avengers.jpeg')">
                <img class="featured-title" src="./avengers-logo-png-transparent-avengers-logo-images-7.png" alt="">
                <p class="featured-desc">Adrift in space with no food or water, Tony Stark sends a message to Pepper Potts as his oxygen supply starts to dwindle. Meanwhile, the remaining Avengers -- Thor, Black Widow, Captain America and Bruce Banner -- must figure out a way to bring back their vanquished allies... </p>
                <form action="../Comingsoon/comingsoon.php">
            ...
            <div class="movie-list-container">
                ...
                <div class="movie-list-wrapper">
                    <div class="movie-list">
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./crazy rich asians.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./pride-prejudice-2005.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./lalaland.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./ATONOMENT.jpeg" alt="">
            ...
            <div class="movie-list-container">
                <h1 class="movie-list-title">ACTION FILMS</h1>
                <div class="movie-list-wrapper">
                    <div class="movie-list">
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./batman.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./badboys.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./topmaverick.jpeg" alt="">
                        ...
                        <div class="movie-list-item">
                            <img class="movie-list-item-img" src="./fastfurious.webp " alt="">
